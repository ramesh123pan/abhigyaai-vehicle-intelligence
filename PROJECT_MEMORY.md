...
All RC entry points now require the four-digit final registration series before live lookup. `UP16AN0593` is valid; `UP16AN593` is rejected before provider access.
